...
canvas.setBackgroundImage('http://placehold.it/640x480/dd0055/?text=BackgroundImage', canvas.renderAll.bind(canvas), {
...
$("#btnZoomOut").click(function(){
    ...
    getFabricCanvases().forEach(function(elementValue) {
        ...
        currentTop = this.zoomCalcYpos(currentTop);
        currentLeft = this.zoomCalcXpos(currentLeft);
